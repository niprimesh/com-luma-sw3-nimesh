...
//* Click on Pants
        Thread.sleep(1000);
        clickMouseHoverOnElements(By.id("ui-id-23"));
//* Mouse Hover on product name‘Cronus Yoga Pant’ and click on size 32.
        clickMouseHoverOnElements(By.xpath("//div[@class='swatch-opt-880']//div[@id='option-label-size-143-item-175']"));
//* Mouse Hover on product name ‘Cronus Yoga Pant’ and click on colour Black.
        clickMouseHoverOnElements(By.xpath("//div[@class='swatch-opt-880']//div[@id='option-label-color-93-item-49']"));
//* Mouse Hover on product name‘Cronus Yoga Pant’ and click on ‘Add To Cart’ Button.
        clickMouseHoverOnElements(By.xpath("//body/div[1]/main[1]/div[3]/div[1]/div[3]/ol[1]/li[1]/div[1]/div[1]/div[3]/div[1]/div[1]"));
