...
public class WomenTest extends Utility {
    ...
    public void verifyTheSortByProductNameFilter() throws InterruptedException {
        ...
        Thread.sleep(1000);
        mouseHoverOnElements(By.xpath("//span[contains(text(),'Women')]"));
        //* Mouse Hover on Tops
        //li[contains(@class,'nav-2-1 ')]/child::a
        mouseHoverOnElements(By.xpath("//li[contains(@class,'nav-2-1 ')]/child::a"));
        //* Click on Jackets
        clickMouseHoverOnElements(By.xpath("//li[contains(@class,'nav-2-1 ')]/child::ul/child::li[1]/child::a"));
...
//* Click on Jackets
        Thread.sleep(1000);
        clickMouseHoverOnElements(By.xpath("//a[@id='ui-id-11']//span[contains(text(),'Jackets')]"));
